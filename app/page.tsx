    ...
    return (
        <>
            ...
            {mode === "solo"
                ...
                <>
                    <section
                        className={"relative w-full h-auto pt-45"}>
                        <span
                        ...
                        {/*Projects Hero*/}
                        <div
                            className={"w-[90%] max-w-small mx-auto border-l flex flex-col justify-center items-start border-black/20 h-150 pl-7"}>
                            <section
